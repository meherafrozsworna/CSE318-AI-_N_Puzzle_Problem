...
public class Search_displacement {
    public void displacement_heuristic_search(int start_state[][])
    {
        ...
        state.set_cost_displacement();
        PriorityQueue<State> q = new PriorityQueue<State>(Comparator.comparing(State -> State.cost_displacement));
